        ...
        <div className="flex items-center justify-between bg-white px-4 py-3 dark:bg-black dark:px-4 dark:py-3">
            <div className="flex items-center gap-8">
                <div className="relative flex h-min w-[200px]">
                    ...
                    <input type="search" placeholder="Search..." className="placholder-gray-500 w-full rounded border-none bg-gray-100 p-2 pl-8 focus:border-transparent focus:outline-none dark:bg-gray-700 dark:text-white dark:placeholder-white" />
                </div>
            </div>
